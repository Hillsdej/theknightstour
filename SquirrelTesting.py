...
class Graph:
    ...
    def squirrel(self, startX, startY, depth=0, moveType=None):
        ...
        if len(self.visited) <= (self.rowLength*self.columnLength):
            ...
            while kmdCounter <= len(knightMovesDict):
                if knightMovesDict[kmdCounter] != None:
                    ...
                    if depth == 1:
                        ...
                        self.squirrel(adjacentNodeX, adjacentNodeY, depth+1, moveType=knightMovesDict[kmdCounter]["moveType"])
                        kmdCounter += 1
            ...
            while relatedCounter < len(sortedRelated):
                ...
                tieList = self.checkForRepeats(sortedRelated)
